...
def make_charts(IMG):
    ...
    banner(ax,"[주의] 30년 수치 미감사 (2026-07-27) — 검증된 방향: 조정본 배당 HAC t 4.10 · B/P 3.34 · E/P 2.36",AMBER)
    ...
    fig.suptitle("두 트랙 — 진입은 추세, 매도는 트랙별 (24년 검정 · [주의] 시점 짝짓기 미감사)",fontproperties=fp,fontsize=12,color=INK,y=1.06)
...
if __name__=="__main__":
    import sys
    out=sys.argv[1] if len(sys.argv)>1 else _jqroot2()
